...
- **Zamknięta lista rozmiarów Gelato** (D‑050): 9 rozmiarów, 3 na orientację (pion 30×40/50×70/70×100, poziom 40×30/70×50/100×70, kwadrat 30×30/50×50/70×70). Każda praca ma orientację; lista/etykieta/podgląd wynikają z niej. Usunięto stare/wymyślone rozmiary. **Luka do zrobienia:** kształt slotów na ścianie wciąż pionowy z układu → prace poziome/kwadratowe są przycinane; dopasowanie kształtu ramki do orientacji = następny krok.
