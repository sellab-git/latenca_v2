...
**Czego NIE dowiedliśmy (luki do świadomej decyzji):** realny flow generowania (nie odpalony) i mobile (resize nie zadziałał). Żadna z tych luk nie blokuje decyzji D‑A…D‑D, ale mobile trzeba obejrzeć zanim zaczniemy budować kod.
